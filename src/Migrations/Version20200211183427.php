 ...
 */
final class Version20200211183427 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, egn VARCHAR(10) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, second_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, phone VARCHAR(20) DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, birth_date DATE DEFAULT NULL, address LONGTEXT DEFAULT NULL, education VARCHAR(255) DEFAULT NULL, work VARCHAR(255) DEFAULT NULL, dtype VARCHAR(255) NOT NULL, INDEX IDX_34DCD17698260155 (region_id), INDEX IDX_34DCD1768A2B47EB (sub_region_id), INDEX IDX_34DCD1768BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE family (id INT AUTO_INCREMENT NOT NULL, woman_id INT DEFAULT NULL, man_id INT DEFAULT NULL, warden_id INT DEFAULT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, titular VARCHAR(50) NOT NULL, prefer_kid_gender VARCHAR(1) DEFAULT NULL, prefer_kid_min_age SMALLINT DEFAULT NULL, prefer_kid_max_age SMALLINT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_A5E6215BEC88A587 (woman_id), UNIQUE INDEX UNIQ_A5E6215BE3037FC8 (man_id), INDEX IDX_A5E6215B9533F2F6 (warden_id), INDEX IDX_A5E6215B98260155 (region_id), INDEX IDX_A5E6215B8A2B47EB (sub_region_id), INDEX IDX_A5E6215B8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE family_member DROP FOREIGN KEY FK_B9D4AD6DBF396750');
        $this->addSql('ALTER TABLE foster_parent DROP FOREIGN KEY FK_C296ABDCBF396750');
