 ...
 */
final class Version20200413230725 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, egn VARCHAR(10) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, second_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, phone VARCHAR(20) DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, birth_date DATE DEFAULT NULL, address LONGTEXT DEFAULT NULL, education VARCHAR(255) DEFAULT NULL, work VARCHAR(255) DEFAULT NULL, employment_type VARCHAR(255) DEFAULT NULL, citizenship VARCHAR(255) DEFAULT NULL, dtype VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64998260155 (region_id), INDEX IDX_8D93D6498A2B47EB (sub_region_id), INDEX IDX_8D93D6498BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE child (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, family_id BIGINT UNSIGNED DEFAULT NULL, warden_id BIGINT UNSIGNED DEFAULT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, egn VARCHAR(10) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, second_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, phone VARCHAR(20) DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, birth_date DATE DEFAULT NULL, address LONGTEXT DEFAULT NULL, education VARCHAR(255) DEFAULT NULL, work VARCHAR(255) DEFAULT NULL, employment_type VARCHAR(255) DEFAULT NULL, citizenship VARCHAR(255) DEFAULT NULL, INDEX IDX_22B35429C35E566A (family_id), INDEX IDX_22B354299533F2F6 (warden_id), INDEX IDX_22B3542998260155 (region_id), INDEX IDX_22B354298A2B47EB (sub_region_id), INDEX IDX_22B354298BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE family (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, woman_id BIGINT UNSIGNED DEFAULT NULL, man_id BIGINT UNSIGNED DEFAULT NULL, warden_id BIGINT UNSIGNED DEFAULT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, titular VARCHAR(50) NOT NULL, prefer_kid_gender VARCHAR(20) DEFAULT NULL, prefer_kid_min_age SMALLINT DEFAULT NULL, prefer_kid_max_age SMALLINT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, level_of_bulgarian_language VARCHAR(255) DEFAULT NULL, religion VARCHAR(255) DEFAULT NULL, family_type VARCHAR(255) DEFAULT NULL, average_monthly_income_per_family_member DOUBLE PRECISION DEFAULT NULL, house_type VARCHAR(255) DEFAULT NULL, another_income DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_A5E6215BEC88A587 (woman_id), UNIQUE INDEX UNIQ_A5E6215BE3037FC8 (man_id), INDEX IDX_A5E6215B9533F2F6 (warden_id), INDEX IDX_A5E6215B98260155 (region_id), INDEX IDX_A5E6215B8A2B47EB (sub_region_id), INDEX IDX_A5E6215B8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE family_member (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, family_id BIGINT UNSIGNED NOT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, relation VARCHAR(255) NOT NULL, note LONGTEXT NOT NULL, egn VARCHAR(10) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, second_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, phone VARCHAR(20) DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, birth_date DATE DEFAULT NULL, address LONGTEXT DEFAULT NULL, education VARCHAR(255) DEFAULT NULL, work VARCHAR(255) DEFAULT NULL, employment_type VARCHAR(255) DEFAULT NULL, citizenship VARCHAR(255) DEFAULT NULL, INDEX IDX_B9D4AD6DC35E566A (family_id), INDEX IDX_B9D4AD6D98260155 (region_id), INDEX IDX_B9D4AD6D8A2B47EB (sub_region_id), INDEX IDX_B9D4AD6D8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE foster_parent (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, region_id INT DEFAULT NULL, sub_region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, egn VARCHAR(10) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, education VARCHAR(255) DEFAULT NULL, address LONGTEXT DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, second_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, birth_date DATE DEFAULT NULL, work VARCHAR(255) DEFAULT NULL, employment_type VARCHAR(255) DEFAULT NULL, citizenship VARCHAR(255) DEFAULT NULL, INDEX IDX_C296ABDC98260155 (region_id), INDEX IDX_C296ABDC8A2B47EB (sub_region_id), INDEX IDX_C296ABDC8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE child DROP FOREIGN KEY FK_22B354298BAC62AF');
        ...
        $this->addSql('ALTER TABLE child DROP FOREIGN KEY FK_22B3542998260155');
        ...
        $this->addSql('ALTER TABLE child DROP FOREIGN KEY FK_22B354298A2B47EB');
